...
<DIV class='content' style='width: 100%;'>     
  ...
  <ASIDE style='float: left;'>
    ...
    >  
    <A href='./list_by_actor.do?actorno=${actorVO.actorno }'>${actorVO.actorname }</A>
      ...
      <tbody>
        <c:forEach var="actorVO" items="${list }">
          <tr> 
            ...
            <td style='vertical-align: middle;'>
              <a href="./update.do?actorno=${actorVO.actorno}"><img src="./images/repair.jpg" title="수정" border='0'/></a>
              <a href="./delete.do?actorno=${actorVO.actorno}"><img src="./images/sak.png" title="삭제"  border='0'/></a>
            </td>
          </tr>
        </c:forEach>
